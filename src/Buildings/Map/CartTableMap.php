...
class CartTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Buildings.Map.CartTableMap';
     ...
     */
    public const OM_CLASS = '\\Buildings\\Cart';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Buildings.Cart';
     ...
     */
    public const COL_ID = 'cart.id';

    /**
     * the column name for the id_client field
     */
    public const COL_ID_CLIENT = 'cart.id_client';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'cart.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'cart.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'IdClient', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['id', 'idClient', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [CartTableMap::COL_ID, CartTableMap::COL_ID_CLIENT, CartTableMap::COL_CREATED_AT, CartTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id', 'id_client', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'IdClient' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'idClient' => 1, 'createdAt' => 2, 'updatedAt' => 3, ],
        self::TYPE_COLNAME       => [CartTableMap::COL_ID => 0, CartTableMap::COL_ID_CLIENT => 1, CartTableMap::COL_CREATED_AT => 2, CartTableMap::COL_UPDATED_AT => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'id_client' => 1, 'created_at' => 2, 'updated_at' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'cart.id' => 'ID',
        'CartTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'IdClient' => 'ID_CLIENT',
        'Cart.IdClient' => 'ID_CLIENT',
        'idClient' => 'ID_CLIENT',
        'cart.idClient' => 'ID_CLIENT',
        'CartTableMap::COL_ID_CLIENT' => 'ID_CLIENT',
        'COL_ID_CLIENT' => 'ID_CLIENT',
        'id_client' => 'ID_CLIENT',
        'cart.id_client' => 'ID_CLIENT',
        'CreatedAt' => 'CREATED_AT',
        'Cart.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'cart.createdAt' => 'CREATED_AT',
        'CartTableMap::COL_CREATED_AT' => 'CREATED_AT',
        'COL_CREATED_AT' => 'CREATED_AT',
        'created_at' => 'CREATED_AT',
        'cart.created_at' => 'CREATED_AT',
        'UpdatedAt' => 'UPDATED_AT',
        'Cart.UpdatedAt' => 'UPDATED_AT',
        'updatedAt' => 'UPDATED_AT',
        'cart.updatedAt' => 'UPDATED_AT',
        'CartTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Buildings\\Cart');
    ...
    {
        $this->addRelation('CartClientId', '\\Buildings\\Client', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id_client',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CartTableMap::COL_ID_CLIENT);
            $criteria->addSelectColumn(CartTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(CartTableMap::COL_UPDATED_AT);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(CartTableMap::COL_ID);
            $criteria->removeSelectColumn(CartTableMap::COL_ID_CLIENT);
            $criteria->removeSelectColumn(CartTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(CartTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Buildings\Cart) { // it's a model object
