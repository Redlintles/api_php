...
abstract class Message implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Buildings\\Map\\MessageTableMap';
    ...
    /**
     * Initializes internal state of Buildings\Base\Message object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MessageTableMap::translateFieldName('Msg', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Buildings\\Message'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Buildings\Message (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Buildings\Message Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
