...
use Buildings\ProductCategory;
use Buildings\ProductCategoryQuery;
...
class ProductCategoryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Buildings.Map.ProductCategoryTableMap';
     ...
     */
    public const OM_CLASS = '\\Buildings\\ProductCategory';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Buildings.ProductCategory';
     ...
     */
    public const COL_ID_PRODUCT = 'product_category.id_product';

    /**
     * the column name for the id_category field
     */
    public const COL_ID_CATEGORY = 'product_category.id_category';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'idProduct' => 'ID_PRODUCT',
        'productCategory.idProduct' => 'ID_PRODUCT',
        'ProductCategoryTableMap::COL_ID_PRODUCT' => 'ID_PRODUCT',
        'COL_ID_PRODUCT' => 'ID_PRODUCT',
        'id_product' => 'ID_PRODUCT',
        'product_category.id_product' => 'ID_PRODUCT',
        'IdCategory' => 'ID_CATEGORY',
        'ProductCategory.IdCategory' => 'ID_CATEGORY',
        'idCategory' => 'ID_CATEGORY',
        'productCategory.idCategory' => 'ID_CATEGORY',
        'ProductCategoryTableMap::COL_ID_CATEGORY' => 'ID_CATEGORY',
