...
abstract class Cart implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Buildings\\Map\\CartTableMap';
    ...
    /**
     * Initializes internal state of Buildings\Base\Cart object.
     */
    ...
    public function setIdClient($v)
    {
        ...
        if ($this->id_client !== $v) {
            $this->id_client = $v;
            $this->modifiedColumns[CartTableMap::COL_ID_CLIENT] = true;
        }

        if ($this->aCartClientId !== null && $this->aCartClientId->getId() !== $v) {
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CartTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CartTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartTableMap::translateFieldName('IdClient', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_client = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CartTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CartTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = CartTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Buildings\\Cart'), 0, $e);
        }
    }
    ...
    {
        if ($this->aCartClientId !== null && $this->id_client !== $this->aCartClientId->getId()) {
            $this->aCartClientId = null;
        }
    }
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(CartTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(CartTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CartTableMap::COL_UPDATED_AT)) {
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCartClientId !== null) {
                if ($this->aCartClientId->isModified() || $this->aCartClientId->isNew()) {
                    $affectedRows += $this->aCartClientId->save($con);
                }
                $this->setCartClientId($this->aCartClientId);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CartTableMap::COL_ID_CLIENT)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CartTableMap::COL_ID_CLIENT)) {
            $criteria->add(CartTableMap::COL_ID_CLIENT, $this->id_client);
        }
        if ($this->isColumnModified(CartTableMap::COL_CREATED_AT)) {
            $criteria->add(CartTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CartTableMap::COL_UPDATED_AT)) {
            $criteria->add(CartTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Buildings\Cart (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Buildings\Cart Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setCartClientId(ChildClient $v = null)
    {
        if ($v === null) {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getCartClientId(?ConnectionInterface $con = null)
    {
        if ($this->aCartClientId === null && ($this->id_client != 0)) {
            $this->aCartClientId = ChildClientQuery::create()->findPk($this->id_client, $con);
