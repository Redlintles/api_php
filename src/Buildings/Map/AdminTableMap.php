...
class AdminTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Buildings.Map.AdminTableMap';
     ...
     */
    public const OM_CLASS = '\\Buildings\\Admin';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Buildings.Admin';
     ...
     */
    public const COL_API_KEY = 'admin.api_key';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'apiKey' => 'API_KEY',
        'admin.apiKey' => 'API_KEY',
        'AdminTableMap::COL_API_KEY' => 'API_KEY',
        'COL_API_KEY' => 'API_KEY',
        'api_key' => 'API_KEY',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Buildings\\Admin');
    ...
    {
        $this->addRelation('Admin', '\\Buildings\\Permission', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':admin_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Buildings\Admin) { // it's a model object
