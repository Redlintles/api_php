...
abstract class Discount implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Buildings\\Map\\DiscountTableMap';
    ...
    public function getStartAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->start_at instanceof \DateTimeInterface ? $this->start_at->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DiscountTableMap::COL_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[DiscountTableMap::COL_TYPE] = true;
        }
    ...
    public function setPercent($v)
    {
        ...
        if ($this->percent !== $v) {
            $this->percent = $v;
            $this->modifiedColumns[DiscountTableMap::COL_PERCENT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DiscountTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DiscountTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DiscountTableMap::translateFieldName('IdProduct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_product = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DiscountTableMap::translateFieldName('IdCategory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_category = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DiscountTableMap::translateFieldName('Percent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->percent = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DiscountTableMap::translateFieldName('StartAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->start_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : DiscountTableMap::translateFieldName('ExpiresAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = DiscountTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Buildings\\Discount'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(DiscountTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DiscountTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(DiscountTableMap::COL_ID_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = 'id_product';
        }
        if ($this->isColumnModified(DiscountTableMap::COL_ID_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'id_category';
        }
        if ($this->isColumnModified(DiscountTableMap::COL_PERCENT)) {
            $modifiedColumns[':p' . $index++]  = 'percent';
        }
        if ($this->isColumnModified(DiscountTableMap::COL_START_AT)) {
            $modifiedColumns[':p' . $index++]  = 'start_at';
        }
        if ($this->isColumnModified(DiscountTableMap::COL_EXPIRES_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'percent':
                        ...
                        break;
                    case 'start_at':
                        $stmt->bindValue($identifier, $this->start_at ? $this->start_at->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setPercent($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setStartAt($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(DiscountTableMap::COL_ID)) {
            $criteria->add(DiscountTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DiscountTableMap::COL_TYPE)) {
            $criteria->add(DiscountTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(DiscountTableMap::COL_ID_PRODUCT)) {
            $criteria->add(DiscountTableMap::COL_ID_PRODUCT, $this->id_product);
        }
        if ($this->isColumnModified(DiscountTableMap::COL_ID_CATEGORY)) {
            $criteria->add(DiscountTableMap::COL_ID_CATEGORY, $this->id_category);
        }
        if ($this->isColumnModified(DiscountTableMap::COL_PERCENT)) {
            $criteria->add(DiscountTableMap::COL_PERCENT, $this->percent);
        }
        if ($this->isColumnModified(DiscountTableMap::COL_START_AT)) {
            $criteria->add(DiscountTableMap::COL_START_AT, $this->start_at);
        }
        if ($this->isColumnModified(DiscountTableMap::COL_EXPIRES_AT)) {
            $criteria->add(DiscountTableMap::COL_EXPIRES_AT, $this->expires_at);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Buildings\Discount (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Buildings\Discount Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
