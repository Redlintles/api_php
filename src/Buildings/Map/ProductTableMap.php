...
class ProductTableMap extends TableMap
{
     ...
     */
    public const COL_DESC = 'product.desc';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Title', 'Desc', 'UnityPrice', 'InStock', ],
        self::TYPE_CAMELNAME     => ['id', 'title', 'desc', 'unityPrice', 'inStock', ],
        self::TYPE_COLNAME       => [ProductTableMap::COL_ID, ProductTableMap::COL_TITLE, ProductTableMap::COL_DESC, ProductTableMap::COL_UNITY_PRICE, ProductTableMap::COL_IN_STOCK, ],
        self::TYPE_FIELDNAME     => ['id', 'title', 'desc', 'unity_price', 'in_stock', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Title' => 1, 'Desc' => 2, 'UnityPrice' => 3, 'InStock' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'title' => 1, 'desc' => 2, 'unityPrice' => 3, 'inStock' => 4, ],
        self::TYPE_COLNAME       => [ProductTableMap::COL_ID => 0, ProductTableMap::COL_TITLE => 1, ProductTableMap::COL_DESC => 2, ProductTableMap::COL_UNITY_PRICE => 3, ProductTableMap::COL_IN_STOCK => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'title' => 1, 'desc' => 2, 'unity_price' => 3, 'in_stock' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('unity_price', 'UnityPrice', 'FLOAT', true, null, null);
