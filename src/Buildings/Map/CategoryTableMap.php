...
class CategoryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Buildings.Map.CategoryTableMap';
     ...
     */
    public const OM_CLASS = '\\Buildings\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Buildings.Category';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Buildings\\Category');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Buildings\Category) { // it's a model object
